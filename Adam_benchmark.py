...
import scratchnet.optimizers.optimizer_Adam as oAdam
...
if __name__ == '__main__':
    ...
    # Create optimizer
    # optimizer = oAdam.Optimizer_Adam(learning_rate=0.02, decay=1e-5)
    optimizer = oAdam.Optimizer_Adam(learning_rate=0.05, decay=5e-7)
