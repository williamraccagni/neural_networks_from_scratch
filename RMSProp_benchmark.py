...
import scratchnet.optimizers.optimizer_RMSProp as oRMSProp
...
if __name__ == '__main__':
    ...
    # Create optimizer
    # optimizer = oRMSProp.Optimizer_RMSprop(decay=1e-4)
    optimizer = oRMSProp.Optimizer_RMSprop(learning_rate=0.02, decay=1e-5, rho=0.999)
